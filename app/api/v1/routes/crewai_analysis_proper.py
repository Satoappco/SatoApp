...
router = APIRouter(prefix="/crewai-proper")
        ...
        with get_session() as session:
            ...
            for agent in agents:
                agent_status.append({
                    ...
                    "has_tools": agent.agent_type == "google_database_analysis_expert",
                    "tool_name": "GA4AnalyticsTool" if agent.agent_type == "google_database_analysis_expert" else None
                })
