...
def get_facebook_connections(user_id: int, subclient_id: int, asset_type: str = "SOCIAL_MEDIA") -> List[tuple]:
    """
...
def get_ga4_connections(user_id: int, subclient_id: int) -> List[tuple]:
    """
...
def get_google_ads_connections(user_id: int, subclient_id: int) -> List[tuple]:
    """
...
def get_user_connections_summary(user_id: int, subclient_id: int) -> Dict[str, int]:
    """
...
def validate_connection_access(user_id: int, connection_id: int) -> bool:
    """
